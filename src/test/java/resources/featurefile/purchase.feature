Feature: Search functionality As a user I want to purchase cheapest and costliest product from the saucedemo after sorting the products by Height to Low filter.
  @smoke
  Scenario: User navigates saucedemo page and complete the item purchase
    ...
    And I enter details firstname "Ron" lastName "Jira" and zipPostalCode "Ub10 10Ub"
